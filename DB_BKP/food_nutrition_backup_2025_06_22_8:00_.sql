...
DROP DATABASE food_nutrition_db;
DROP DATABASE food_nutrition_test_db;
...
CREATE ROLE food_nutrition_user;
ALTER ROLE food_nutrition_user WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:90P2lM2/Gryuyoep6D+RpA==$hbaI4c6lIhFEiwYg1iUQjAqORvEeVc7c8iEZ3xMmUtA=:GQ/3BwNmPIWu0wUqTo9N8tIfZUkgGzP3OqCuGOOkziw=';
...
--
-- Name: template1; Type: DATABASE; Schema: -; Owner: food_nutrition_user
--

CREATE DATABASE template1 WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE template1 OWNER TO food_nutrition_user;
...
--
-- Name: DATABASE template1; Type: COMMENT; Schema: -; Owner: food_nutrition_user
--
...
--
-- Name: template1; Type: DATABASE PROPERTIES; Schema: -; Owner: food_nutrition_user
--
...
--
-- Name: DATABASE template1; Type: ACL; Schema: -; Owner: food_nutrition_user
--
...
--
-- Database "food_nutrition_db" dump
--
...
--
-- Name: food_nutrition_db; Type: DATABASE; Schema: -; Owner: food_nutrition_user
--

CREATE DATABASE food_nutrition_db WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE food_nutrition_db OWNER TO food_nutrition_user;

\connect food_nutrition_db
...
--
-- Name: users; Type: TABLE; Schema: public; Owner: food_nutrition_user
--
...
ALTER TABLE public.users OWNER TO food_nutrition_user;

--
-- Name: users_id_seq; Type: SEQUENCE; Schema: public; Owner: food_nutrition_user
--
...
ALTER TABLE public.users_id_seq OWNER TO food_nutrition_user;

--
-- Name: users_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: food_nutrition_user
--
...
--
-- Name: users id; Type: DEFAULT; Schema: public; Owner: food_nutrition_user
--
...
ad7a2dc5-cda3-4449-8339-7b2edbba2cd2	93a0cd0508f3425fbe9c288e7f3a93b6db9fe5beaf01048a7484d5e1902ceb1a	2025-06-17 16:18:13.239308+00	20250617161809_add_user_model	\N	\N	2025-06-17 16:18:12.573506+00	1
\.
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: food_nutrition_user
--

COPY public.users (id, username, password, created_at, updated_at) FROM stdin;
1	admin	$2b$10$um3gAz6lHjHQiPEgWcn0v.l1UzGabDZn2U4bLWtoE3FMj4ylyPDSG	2025-06-17 16:21:12.374+00	2025-06-17 16:21:12.374+00
2	sahan	$2b$10$ILzxZMCgDEy3bmRamXzzQ.vqNXivAx1HuPerx5Ez85EjJjlRL3wtm	2025-06-22 01:40:43.665+00	2025-06-22 01:40:43.665+00
\.
...
--
-- Name: users_id_seq; Type: SEQUENCE SET; Schema: public; Owner: food_nutrition_user
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: food_nutrition_user
--
...
--
-- Name: users_username_key; Type: INDEX; Schema: public; Owner: food_nutrition_user
--
...
--
-- Database "food_nutrition_test_db" dump
--
...
--
-- Name: food_nutrition_test_db; Type: DATABASE; Schema: -; Owner: food_nutrition_user
--

CREATE DATABASE food_nutrition_test_db WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE food_nutrition_test_db OWNER TO food_nutrition_user;

\connect food_nutrition_test_db
...
--
-- Name: postgres; Type: DATABASE; Schema: -; Owner: food_nutrition_user
--

CREATE DATABASE postgres WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';


ALTER DATABASE postgres OWNER TO food_nutrition_user;
...
--
-- Name: DATABASE postgres; Type: COMMENT; Schema: -; Owner: food_nutrition_user
--
